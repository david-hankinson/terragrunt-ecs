...
#     {
#       name  = "rails"
#       image = "891377081827.dkr.ecr.ca-central-1.amazonaws.com/ecr-rails-bank-trx-reporting:v1.0.11"  # You'll need to build and push this image to ECR or another registry
#       essential = true
#       environment = [
...
#     {
#       name  = "sidekiq"
#       image = "891377081827.dkr.ecr.ca-central-1.amazonaws.com/ecr-rails-bank-trx-reporting:v1.0.11"  # Same as rails container
#       essential = true
